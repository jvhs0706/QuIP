...
salloc --time=0-02:59 --account=rrg-hongyanz --cpus-per-task=12 --mem=127500M --gpus=a100:1 srun $VIRTUAL_ENV/bin/jupyterlab.sh
# salloc --time=0-02:59 --nodes=1 --gpus-per-node=a100:4 --ntasks-per-node=1 --cpus-per-task=48 --exclusive --mem=510000M --account=rrg-hongyanz srun $VIRTUAL_ENV/bin/jupyterlab.sh